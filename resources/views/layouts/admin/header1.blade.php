...
<body data-sidebar="colored">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            <a href="{{route('admin.users')}}" class="waves-effect">
                                <i class="fas fa-users"></i><span class="badge rounded-pill bg-success float-end"></span>
                                <span>Users</span>
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="{{ route('admin.ambulance.index') }}" class="waves-effect">
                                <i class="fas fa-ambulance"></i><span class="badge rounded-pill bg-success float-end"></span>
    ...
    <!-- Vector map-->
    <script src="{{ asset('admin_panel/assets/libs/jsvectormap/js/jsvectormap.min.js') }}"></script>
    <script src="{{ asset('admin_panel/assets/libs/jsvectormap/maps/world-merc.js') }}"></script>

    <script src="{{ asset('admin_panel/assets/js/pages/dashboard.init.js') }}"></script>
